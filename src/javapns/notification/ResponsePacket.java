...
public class ResponsePacket {
	...
	protected void linkToPushedNotification(PushNotificationManager notificationManager) {
		try {
			PushedNotification notification = notificationManager.getPushedNotifications().get(identifier);
			if (notification != null) notification.setResponse(this);
		} catch (Exception e) {
		}
	}
	...
	public String getMessage() {
		if (command == 8) {
			String prefix = "APNS: "; //APNS ERROR FOR MESSAGE ID #" + identifier + ": ";
